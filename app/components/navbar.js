  ...
  return (
    <nav className="p-4 shadow bg-white flex justify-center text-base gap-12 text-gray-400 ">
      ...
      {role === "client" ? ( // Si le rôle est 'client'
        <>
          <Link href="/client/dashboard" className="flex">
            {" "}
            <Sprout className="mr-2" />
            Dashboard
          </Link>
          <Link href="/client/collectes" className="flex">
            {" "}
            <PackagePlus className="mr-2" />
            Collectes
          </Link>
          <Link href="/client/dons" className="flex">
            {" "}
            <Heart className="mr-2" />
            Dons
          </Link>
          <Link href="/client/profil" className="flex">
            {" "}
            <User className="mr-2" />
            Profil
          </Link>
