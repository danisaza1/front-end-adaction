...
export default function Collectes({ initialCities }) {
  ...
  const [cities, setCities] = useState(initialCities);; //Ici, nous faisons appel à un tableau que nous avons prédéfini.
